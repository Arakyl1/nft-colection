...
type modelName = getModelName<'Comment'>
const modelName: Uncapitalize<modelName> = 'comment'
type ThisMainTypeWhereInput = Prisma.CommentWhereInput
type ThisMainTypeSelect = Prisma.CommentSelect
type ThisMainTypeInclude = Prisma.CommentInclude

const propertyElem: Array<keyof ThisMainTypeWhereInput> = ['id', 'authorId', 'createAt','rating','text']
...
const PropertyElemString: PropertyElemString[] = ['text']
...
type keyPropElemRelation = keyof Pick<ThisMainTypeInclude, 'author' | 'blogCard' | 'card' | 'colection'>
const keyPropElemRelation: keyPropElemRelation[] = ['author','blogCard','card','colection']
